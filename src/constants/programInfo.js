...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to prepare students with a foundation for a career in Information Technology. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
